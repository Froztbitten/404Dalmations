...
public class Finances
{
    ...
    private float previousMonthUtilities;
    ...
    public float getPreviousMonthUtilities() {
        return previousMonthUtilities;
    }

    public void setPreviousMonthUtilities(float previousMonthUtilities) {
        this.previousMonthUtilities = previousMonthUtilities;
    }
